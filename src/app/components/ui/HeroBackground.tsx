...
export default function HeroBackground({ className = "" }: { className?: string }) {
  return (
    ...
    >
      <g id="Background">
        <path id="Light Blue Background" fillRule="evenodd" clipRule="evenodd" d="M3868.63 1339.5C3972.08 1339.5 4217.38 1335.16 4317 1339.5V0H0V2101.86C126.206 2108.41 257.394 2112 393.362 2112C1953.16 2112 2521.53 1339.5 3868.63 1339.5Z" fill="url(#paint0_linear_1_316)"/>
        ...
        <mask id="mask0_1_316" style={{ maskType: 'luminance' }} maskUnits="userSpaceOnUse" x="0" y="0" width="4320" height="2112">
